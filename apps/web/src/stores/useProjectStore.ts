...
export const useProjectStore = create<ProjectState>((set, get) => ({
  ...
  fetchProjects: async (repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao carregar lista de projetos: ${msg}`,
      });
    }
  },
  ...
  loadProject: async (id: string, repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao abrir projeto: ${msg}`,
      });
      return null;
    }
  },
  ...
  createProject: async (params: CreateProjectParams, repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao criar projeto: ${msg}`,
      });
      throw err;
    }
  },
  ...
  saveProject: async (repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        saveStatus: 'error',
        errorMessage: `Erro ao salvar localmente: ${msg}`,
      });
    }
  },
  ...
  deleteProject: async (id: string, repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao excluir projeto: ${msg}`,
      });
    }
  },
  ...
  duplicateProject: async (id: string, repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao duplicar projeto: ${msg}`,
      });
      throw err;
    }
  },
  ...
  importProject: async (doc: ProjectDocument, repository = defaultProjectRepository) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        errorMessage: `Erro ao importar projeto: ${msg}`,
      });
      throw err;
    }
  },
